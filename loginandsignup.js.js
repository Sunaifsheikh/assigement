...
function signup() {
    ...
    // if (signupusername  && signupemailid && signuppassword !== -1) {
    //     alreadyusername
    // }
    ...
    if (signupusername.indexOf(" ") > -1) {
        ...
        if (!usernameforsignup) {
            ...
            if ((signupusername.length &&  signupemailid.length && signuppassword.length) > 0 && ((signupemailid.indexOf("@") + 1) !== signupemailid.length) && signupemailid.indexOf("@") > -1) {
                ...
                window.location.href = "teams.html.html";
